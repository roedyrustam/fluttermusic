                                             ...
                                             <div class="modal-body">
                                                <div class="form-body">
                                                   ...
                                                   <div class="row" >
                                                      <div class="col-md-12">
                                                         <div class="form-group">
                                                            <label class="control-label"> Choose Parent Category (optional)</label>
                                                            <div class="fallback">
                                                               <select id="categories" name="parent_category" class="form-control" style="margin-top: 10px;">
                                                   ...
                                                   <div class="row p-t-20">
                                                      <div class="col-md-12">
                                                         <div class="form-group">
                                                            ...
                                                            <input type="text" id="edit_name" name="category_name" class="form-control" placeholder=" Name" >
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <div class="row" >
                                    ...
                                    <table id="footer-search" class="excel-bg table table-bordered nowrap">
                                       ...
                                       <tbody style="text-align: center;">
                                          ...
                                          <tr id="<?php echo  $i; ?>" style="line-height: 25px;">
                                             ...
                                             <td><?php echo $parent = ($cat->parent_category_name  ? $cat->parent_category_name  : '-')  ?></td>
                                             <!--<td>-->
                                             <!--   <img src='<?php echo base_url().'/'.$cat->category_image?>' style="width: 65px">--> 
                                             <!--</td>-->
                                             <td>
                                             ...
                                             <td><a data-toggle="modal" data-target="#edit-category" class="edit_cat" id="<?php echo $cat->category_id.'|'.$cat->category_name.'|'.$cat->parent_category_id?>" style="cursor: pointer;">
   ...
   <script type="text/javascript">
      $(document).ready(function(){
          $('.edit_cat').click(function(){
            ...
            var cat_id = result[0];
            var name = result[1];
            var parent_category_id= result[2];
            $('#edit_id').attr('value',cat_id);
            $('#edit_name').attr('value',name);
            $('select#categories option[value ="'+parent_category_id+'"]').attr('selected','');
          });
