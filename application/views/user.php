                                    ...
                                    <table id="footer-search" class="excel-bg table table-bordered nowrap">
                                       ...
                                       <tbody style="text-align: center;" id="invoice_api">
                                          ...
                                          <tr>
                                             ...
                                             <td><img src='<?php echo base_url($user->user_profile_pic)?>' style="width: 65px;height: 65px; border-radius: 50%"></td>
                                            ...
                                            <?php } ?>
                                             ...
                                             <td><?php echo $user->package_name;?>
                                                <a href="<?=base_url()?>admin/userPayments/<?php echo $user->user_id; ?>" ><br>  
                                                <span class="pcoded-badge label label-info"><i class="fa fa-usd"></i></span>
                                                </a>
                                             </td>
                                             <td><?php echo $user->user_package_expiry_date;?></td>
                                             <td><?php echo $user->user_package_paid_date?>
                                             </td>
                                          </tr>
                                          <?php } ?> 
                                       </tbody>
